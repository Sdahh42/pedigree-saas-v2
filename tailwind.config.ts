/**
 * Configuration Tailwind CSS pour PedigreeApp SaaS
 * Utilise le système de design shadcn/ui
 */

import type { Config } from 'tailwindcss';

const config: Config = {
  // Mode sombre basé sur la classe
  darkMode: ['class'],
  ...
  theme: {
    ...
    extend: {
      // Couleurs personnalisées (système shadcn/ui)
      colors: {
        ...
        // Couleurs pour les sexes (chiens)
        male: {
